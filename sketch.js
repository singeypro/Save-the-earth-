...
function preload(){
  ...
  screamSound = loadSound("sound/screamSound.wav")
  baseSound = loadSound("sound/baseSound.wav")
  destroySound = loadSound("sound/destroySound.wav")
  personSaved = loadSound("sound/personsaved.wav")
...
function draw() {
  ...
  if(gameState === PLAY){
      ...
      if(life === 0){
        ...
        if(spaceShipGroup1.isTouching(playerShip)){
          life -= 1
          spaceshipGroup1.destroyEach()
            if(life === 2){
              heart3.visible = false
      ...
      if(spaceShipGroup2.isTouching(playerShip)){
        life -= 1
        spaceShipGroup2.destroyEach()
          if(life === 2){
            heart3.visible = false
    ...
    if(spaceShipGroup3.isTouching(playerShip)){
      life -= 1
      spaceShipGroup3.destroyEach()
        if(life === 2){
          heart3.visible = false
    ...
    if(life === 0){
      ...
      if(spaceShipGroup4.isTouching(playerShip)){
          life -= 1
          spaceShipGroup4.destroyEach()
            if(life === 2){
              heart3.visible = false
